...
public class ControlJuegos {
    ...
    public void insertar(String viju_titulo,String viju_nombre,String viju_ano,String viju_protagonistas,String viju_director,String viju_productor,String viju_tecnologia,Integer viju_precio_alquiler){
    ...
    try{
        ...
        sql = "insert into video_juegos(viju_titulo, viju_nombre, viju_ano, viju_protagonistas, viju_director, viju_productor, viju_tecnologia, viju_precio_alquiler) values(?,?,?,?,?,?,?,?)";
